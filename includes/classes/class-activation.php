...
class EDD_Commissions_Activation {
    ...
    public function missing_commissions_notice() {
        if ( $this->has_edd_commissions ) {
            echo '<div class="error"><p>' . $this->plugin_name . sprintf( __( ' requires %sEDD Commissions%s. Please activate it to continue.', 'edd-commission-thresholds' ), '<a href="https://easydigitaldownloads.com/downloads/commissions/" title="EDD Commissions" target="_blank">', '</a>' ) . '</p></div>';
        } else {
